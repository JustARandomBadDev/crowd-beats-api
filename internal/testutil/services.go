...
func (t *TokenManager) NewToken(_ int) (string, error) {
...
type RoomRepo struct {
	...
	CreateQRCodeFn     func(context.Context, uuid.UUID, string, time.Time) error
...
func (r *RoomRepo) CreateQRCode(ctx context.Context, roomID uuid.UUID, code string, expiresAt time.Time) error {
	if r.CreateQRCodeFn == nil {
		return nil
	}
	return r.CreateQRCodeFn(ctx, roomID, code, expiresAt)
}
...
type SessionRepo struct {
	...
	ReattachFn         func(context.Context, uuid.UUID, uuid.UUID, string) error
...
func (r *SessionRepo) Reattach(ctx context.Context, sessionID uuid.UUID, roomID uuid.UUID, nickname string) error {
	if r.ReattachFn == nil {
		return nil
	}
	return r.ReattachFn(ctx, sessionID, roomID, nickname)
}
...
func (r *TrackRepo) GetActiveDuplicate(ctx context.Context, roomID uuid.UUID, spotifyTrackRefID uuid.UUID) (track.DuplicateInfo, error) {
	if r.GetActiveDuplicateFn == nil {
		return track.DuplicateInfo{}, nil
	}
